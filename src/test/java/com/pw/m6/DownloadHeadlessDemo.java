...
public class DownloadHeadlessDemo extends ScriptBase {
    ...
    public void downloadHeadlessTest() {
        ...
        download.saveAs(Paths.get(new File("C:\\Users\\Yordan Stanchev\\Documents\\GitHub\\PluralSight_Playwright\\src\\PlaywrightDownloads\\downloaded-headless.pdf").toURI()));
    }
}
